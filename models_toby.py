...
def create_model(
    ...
    elif model_params['model_type'] in ['simple_cnn', 'posenet_cnn', 'cnn_toby']:
        model = CNN(
            in_dim=in_dim,
            in_channels=in_channels,
            out_dim=out_dim,
    ...
    elif model_params['model_type'] == 'CNN_3D_toby':
        model = CNN_3D_toby(
            in_dim=in_dim,
            in_channels=in_channels,
            out_dim=out_dim,
...
class CNN_3D_toby(nn.Module):
    def __init__(
        ...
        super(CNN_3D_toby, self).__init__()
